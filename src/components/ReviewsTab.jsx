    ...
    <div>
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <select
          ...
          className="bg-[#0B1120] border border-slate-700 text-slate-300 text-sm px-2 py-1 rounded"
        >
      ...
      <div className="mt-4 flex justify-center gap-2">
        <button
          ...
          className="px-3 py-1 bg-[#0B1120] border border-slate-700 text-slate-300 rounded"
        >
          Prev
        </button>
  ...
  return (
    <div className="bg-[#0B1120] border border-slate-800 p-4 rounded">
      ...
      <textarea
        ...
        className="w-full mt-3 p-2 bg-transparent border border-slate-700 text-white rounded"
        rows={4}
      />
      ...
      <div className="mt-3 flex gap-2">
        <button
          ...
          className="px-3 py-2 bg-[#FF7A1A] rounded text-black font-semibold"
        >
          Post Review
        </button>
        ...
        <button
          ...
          className="px-3 py-2 border border-slate-700 rounded text-slate-300"
        >
          Clear
        </button>
      </div>
